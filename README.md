...
[![Tests - Install YQ Action](https://github.com/step-security/install-yq-action/actions/workflows/tests.yaml/badge.svg)](https://github.com/step-security/install-yq-action/actions/workflows/tests.yaml)
...
* [linux](./examples/example-linux.yaml)
* [macos](./examples/example-macos.yaml)
* [windows](./examples/example-windows.yaml)
